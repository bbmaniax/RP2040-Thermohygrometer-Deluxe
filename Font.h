...
const uint8_t font6x8[96][6] PROGMEM = {
  ...
  {0x15, 0x16, 0x7C, 0x16, 0x15, 0x00},  // \ (92)
  ...
  {0xFC, 0x18, 0x24, 0x24, 0x18, 0x00},  // p (112)
  {0x18, 0x24, 0x24, 0x18, 0xFC, 0x00},  // q (113)
  {0x7C, 0x08, 0x04, 0x04, 0x08, 0x00},  // r (114)
  {0x48, 0x54, 0x54, 0x54, 0x24, 0x00},  // s (115)
  {0x04, 0x04, 0x3F, 0x44, 0x24, 0x00},  // t (116)
  ...
  {0x4C, 0x90, 0x90, 0x90, 0x7C, 0x00},  // y (121)
  ...
  {0x3C, 0x26, 0x23, 0x26, 0x3C, 0x00},  // DEL (127)
};

inline const uint8_t* getCharBytes(char c) {
  if (c >= 0x20 && c <= 0x7F) { return font6x8[c - 0x20]; }
  return nullptr;
}
